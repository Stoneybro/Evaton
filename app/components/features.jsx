   ...
   return (
     <div className='bg-secondary lg:px-20 gap-8 lg:gap-0 py-[4.1rem] flex flex-col lg:flex-row text-white' >
        <div className="flex flex-col justify-center items-center lg:px-8">
            <div className=""><Image src={Book}  alt="Book" /></div>
            <div className="">
                <h1 className='font-bold text-white text-center mt-4 mb-2 lg:my-4 text-2xl'>BALANCED CURRICULUM</h1>
                <div className='text-center text-zinc-300 font-medium text-xl px-3'>
Your chance to give your ward a solid educational background. Our curriculum and activities give them good exposure and detailed training.</div>
        ...
        <div className="flex flex-col justify-center items-center lg:px-8 lg:border-l-[0.5px] border-r-[0.5px] py-2 border-white border-opacity-20">
            <div className=""><Image src={Building}  alt="Building" /></div>
            <div className="">
                <h1 className='font-bold text-white text-center mt-4 mb-2 lg:my-4 text-2xl'>STATE OF THE ART FACILITIES</h1>
                <div className='text-center text-zinc-300 font-medium text-xl px-3'>
Our facilities go beyond the major. It covers more areas of learning and creates a good environment to make schooling a great experience.</div>
        ...
        <div className="flex flex-col justify-center items-center lg:px-8">
            <div className=""><Image src={Building2}  alt="Building2" /></div>
            <div className="">
                <h1 className='font-bold text-white text-center mt-4 mb-2 lg:my-4 text-2xl'>UNIQUE EDUCATIONAL GOALS</h1>
                <div className='text-center text-zinc-300 font-medium text-xl px-2'>
